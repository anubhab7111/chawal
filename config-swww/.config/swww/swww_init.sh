...
case $(date +%H) in
	00 | 01 | 02 | 03 | 04 | 05 | 06 | 07) # First 8 hours of the day
		...
		swww-daemon && swww img ~/Pictures/wallpapers/walls-catppuccin-mocha/astronaut.png
		;;
	08 | 09 | 10 | 11 | 12 | 13 | 14 | 15) # Middle 8 hours of the day
		# Same as above, but for the middle 8 hours of the day

		swww-daemon && swww img ~/Pictures/wallpapers/walls-catppuccin-mocha/dominik-mayer-15.jpg
		;;
	16 | 17 | 18 | 19 | 20 | 21 | 22 | 23) # Final 8 hours of the day
		# Same as above, but for the final 8 hours of the day

		swww-daemon && swww img ~/Pictures/wallpapers/walls-catppuccin-mocha/flying-comets-clouds.jpg
		;;
esac
